...
public class UIHelper {
    ...
    public static final Color COLOR_HEADER_BG = new Color(240, 248, 255); // Alice Blue
    public static final Color COLOR_BACKGROUND = new Color(245, 245, 250); // Nền nhẹ
    public static final Color COLOR_BUTTON = new Color(66, 139, 202); // #428BCA
